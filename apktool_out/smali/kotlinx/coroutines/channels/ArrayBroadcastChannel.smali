...
.method private final updateHead(Lkotlinx/coroutines/channels/ArrayBroadcastChannel$Subscriber;Lkotlinx/coroutines/channels/ArrayBroadcastChannel$Subscriber;)V
    ...
    .end local v7    # "$i$a$-withLock-ArrayBroadcastChannel$updateHead$1":I
    .end local v8    # "minHead":J
    .local v22, "$i$a$-withLock-ArrayBroadcastChannel$updateHead$1":I
    .local v24, "minHead":J
    int-to-long v7, v2
    ...
    invoke-direct {v1, v7, v8}, Lkotlinx/coroutines/channels/ArrayBroadcastChannel;->setTail(J)V
    ...
    .end local v22    # "$i$a$-withLock-ArrayBroadcastChannel$updateHead$1":I
    .end local v23    # "wasFull":Z
    ...
    .end local v7    # "$i$a$-withLock-ArrayBroadcastChannel$updateHead$1":I
    .end local v8    # "minHead":J
    .restart local v22    # "$i$a$-withLock-ArrayBroadcastChannel$updateHead$1":I
    .restart local v23    # "wasFull":Z
    .restart local v24    # "minHead":J
    move-object/from16 v3, v16
