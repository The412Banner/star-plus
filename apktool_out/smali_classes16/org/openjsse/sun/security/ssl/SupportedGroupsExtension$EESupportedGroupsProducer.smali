.class final Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$EESupportedGroupsProducer;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x1a
    name = "EESupportedGroupsProducer"
.end annotation
...
.method synthetic constructor <init>(Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$1;)V
    ...
    .line 994
    invoke-direct {p0}, Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$EESupportedGroupsProducer;-><init>()V
...
.method public produce(Lorg/openjsse/sun/security/ssl/ConnectionContext;Lorg/openjsse/sun/security/ssl/SSLHandshake$HandshakeMessage;)[B
    ...
    sget-object v2, Lorg/openjsse/sun/security/ssl/SSLExtension;->EE_SUPPORTED_GROUPS:Lorg/openjsse/sun/security/ssl/SSLExtension;
    ...
    .line 1029
    :cond_2
    iget-object v9, v0, Lorg/openjsse/sun/security/ssl/ServerHandshakeContext;->activeProtocols:Ljava/util/List;
    ...
    iget-object v9, v0, Lorg/openjsse/sun/security/ssl/ServerHandshakeContext;->activeCipherSuites:Ljava/util/List;
    ...
    iget-object v9, v0, Lorg/openjsse/sun/security/ssl/ServerHandshakeContext;->algorithmConstraints:Ljava/security/AlgorithmConstraints;
    ...
    sget-object v12, Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$EESupportedGroupsProducer;->namedGroupParams:Ljava/util/Map;
    ...
    iput-object v7, v6, Lorg/openjsse/sun/security/ssl/TransportContext;->serverRequestedNamedGroups:Ljava/util/List;

    .line 1060
    new-instance v6, Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$SupportedGroupsSpec;

    invoke-direct {v6, v1, v3}, Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$SupportedGroupsSpec;-><init>(Ljava/util/List;Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$1;)V

    move-object v3, v6

    .line 1061
    .local v3, "spec":Lorg/openjsse/sun/security/ssl/SupportedGroupsExtension$SupportedGroupsSpec;
    iget-object v6, v0, Lorg/openjsse/sun/security/ssl/ServerHandshakeContext;->handshakeExtensions:Ljava/util/Map;

    sget-object v7, Lorg/openjsse/sun/security/ssl/SSLExtension;->EE_SUPPORTED_GROUPS:Lorg/openjsse/sun/security/ssl/SSLExtension;
