.class final Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$CHECPointFormatsConsumer;
...
.method synthetic constructor <init>(Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$1;)V
    ...
    .line 207
    invoke-direct {p0}, Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$CHECPointFormatsConsumer;-><init>()V
...
.method public consume(Lorg/openjsse/sun/security/ssl/ConnectionContext;Lorg/openjsse/sun/security/ssl/SSLHandshake$HandshakeMessage;Ljava/nio/ByteBuffer;)V
    ...
    const-string v2, "Ignore unavailable ec_point_formats extension"
    ...
    :cond_1
    :try_start_0
    new-instance v1, Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$ECPointFormatsSpec;

    const/4 v2, 0x0

    invoke-direct {v1, p3, v2}, Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$ECPointFormatsSpec;-><init>(Ljava/nio/ByteBuffer;Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$1;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    .line 235
    .local v1, "spec":Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$ECPointFormatsSpec;
    nop

    .line 238
    invoke-static {v1}, Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$ECPointFormatsSpec;->access$500(Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$ECPointFormatsSpec;)Z
    ...
    const-string v4, "Invalid ec_point_formats extension data: peer does not support uncompressed points"
    ...
    .line 233
    .end local v1    # "spec":Lorg/openjsse/sun/security/ssl/ECPointFormatsExtension$ECPointFormatsSpec;
    :catch_0
    move-exception v1
