.class final Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator;
.end annotation

.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x1a
    name = "DHEKAKeyDerivation"
.end annotation
...
.method constructor <init>(Lorg/openjsse/sun/security/ssl/HandshakeContext;Ljava/security/PrivateKey;Ljava/security/PublicKey;)V
    ...
    .line 458
    iput-object p1, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->context:Lorg/openjsse/sun/security/ssl/HandshakeContext;

    .line 459
    iput-object p2, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->localPrivateKey:Ljava/security/PrivateKey;

    .line 460
    iput-object p3, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->peerPublicKey:Ljava/security/PublicKey;
...
.method private t12DeriveKey(Ljava/lang/String;Ljava/security/spec/AlgorithmParameterSpec;)Ljavax/crypto/SecretKey;
    ...
    iget-object v1, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->localPrivateKey:Ljava/security/PrivateKey;

    invoke-virtual {v0, v1}, Ljavax/crypto/KeyAgreement;->init(Ljava/security/Key;)V

    .line 478
    iget-object v1, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->peerPublicKey:Ljava/security/PublicKey;
    ...
    iget-object v2, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->context:Lorg/openjsse/sun/security/ssl/HandshakeContext;
    ...
    .line 490
    iget-object v3, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->context:Lorg/openjsse/sun/security/ssl/HandshakeContext;
    ...
    iget-object v5, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->context:Lorg/openjsse/sun/security/ssl/HandshakeContext;
...
.method private t13DeriveKey(Ljava/lang/String;Ljava/security/spec/AlgorithmParameterSpec;)Ljavax/crypto/SecretKey;
    ...
    iget-object v9, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->context:Lorg/openjsse/sun/security/ssl/HandshakeContext;
...
.method public deriveKey(Ljava/lang/String;Ljava/security/spec/AlgorithmParameterSpec;)Ljavax/crypto/SecretKey;
    ...
    .line 466
    iget-object v0, p0, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->context:Lorg/openjsse/sun/security/ssl/HandshakeContext;
    ...
    .line 467
    invoke-direct {p0, p1, p2}, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->t12DeriveKey(Ljava/lang/String;Ljava/security/spec/AlgorithmParameterSpec;)Ljavax/crypto/SecretKey;
    ...
    .line 469
    :cond_0
    invoke-direct {p0, p1, p2}, Lorg/openjsse/sun/security/ssl/DHKeyExchange$DHEKAGenerator$DHEKAKeyDerivation;->t13DeriveKey(Ljava/lang/String;Ljava/security/spec/AlgorithmParameterSpec;)Ljavax/crypto/SecretKey;
