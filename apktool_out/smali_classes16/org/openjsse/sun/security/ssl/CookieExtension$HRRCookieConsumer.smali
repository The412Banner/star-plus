.class final Lorg/openjsse/sun/security/ssl/CookieExtension$HRRCookieConsumer;
...
.method synthetic constructor <init>(Lorg/openjsse/sun/security/ssl/CookieExtension$1;)V
    ...
    .line 246
    invoke-direct {p0}, Lorg/openjsse/sun/security/ssl/CookieExtension$HRRCookieConsumer;-><init>()V
...
.method public consume(Lorg/openjsse/sun/security/ssl/ConnectionContext;Lorg/openjsse/sun/security/ssl/SSLHandshake$HandshakeMessage;Ljava/nio/ByteBuffer;)V
    ...
    const-string v2, "Ignore unavailable cookie extension"
    ...
    :cond_1
    :try_start_0
    new-instance v1, Lorg/openjsse/sun/security/ssl/CookieExtension$CookieSpec;

    const/4 v2, 0x0

    invoke-direct {v1, p3, v2}, Lorg/openjsse/sun/security/ssl/CookieExtension$CookieSpec;-><init>(Ljava/nio/ByteBuffer;Lorg/openjsse/sun/security/ssl/CookieExtension$1;)V
    :try_end_0
    ...
    .line 270
    .end local v1    # "spec":Lorg/openjsse/sun/security/ssl/CookieExtension$CookieSpec;
    :catch_0
    move-exception v1
