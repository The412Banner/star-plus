.class final Lorg/openjsse/sun/security/ssl/CertStatusExtension$CHCertStatusReqV2Consumer;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x1a
    name = "CHCertStatusReqV2Consumer"
.end annotation
...
.method synthetic constructor <init>(Lorg/openjsse/sun/security/ssl/CertStatusExtension$1;)V
    ...
    .line 937
    invoke-direct {p0}, Lorg/openjsse/sun/security/ssl/CertStatusExtension$CHCertStatusReqV2Consumer;-><init>()V
...
.method public consume(Lorg/openjsse/sun/security/ssl/ConnectionContext;Lorg/openjsse/sun/security/ssl/SSLHandshake$HandshakeMessage;Ljava/nio/ByteBuffer;)V
    ...
    const-string v2, "Ignore unavailable status_request_v2 extension"
    ...
    :cond_1
    :try_start_0
    new-instance v1, Lorg/openjsse/sun/security/ssl/CertStatusExtension$CertStatusRequestV2Spec;

    const/4 v2, 0x0

    invoke-direct {v1, p3, v2}, Lorg/openjsse/sun/security/ssl/CertStatusExtension$CertStatusRequestV2Spec;-><init>(Ljava/nio/ByteBuffer;Lorg/openjsse/sun/security/ssl/CertStatusExtension$1;)V
    :try_end_0
    ...
    .line 970
    iget-boolean v2, v0, Lorg/openjsse/sun/security/ssl/ServerHandshakeContext;->isResumption:Z

    if-nez v2, :cond_2

    .line 971
    iget-object v2, v0, Lorg/openjsse/sun/security/ssl/ServerHandshakeContext;->handshakeProducers:Ljava/util/HashMap;
